      ...
      <div className="mt-8" id="education-section">
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col items-end">
                ...
                <span className="text-gray-700">{exp.startedAt}-{exp.endedAt}</span>
                <span></span>
        ...
        {achievementsData?.map((exp, index) => {
          return (
            ...
            >
              <div className="flex flex-col py-2">
               <span className="text-lg font-normal"> {exp.achieveTitle}</span>
        ...
        {trainingData?.map((exp, index) => {
          return (
            ...
            >
              <div className="flex flex-col py-2">
               <span className="text-lg font-normal"> {exp.trainingTitle}</span>
                <span className="text-gray-700">{exp.description}</span>
              </div>
              <div className="flex flex-col items-end">
        ...
        {awardsData?.map((exp, index) => {
          return (
            ...
            >
              ...
              <div className="flex flex-col items-end">
                <span className="text-lg font-normal">{exp.organization}</span>
