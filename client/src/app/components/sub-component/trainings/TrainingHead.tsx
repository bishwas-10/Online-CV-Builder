...
import { deleteTrainingField, setTrainingVisibility, unsetTrainingVisibility } from "@/app/store/trainingSlice";
              ...
              >
                <div className="flex flex-row items-center gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-gray-500 text-sm">{items?.completionDate}</span>
