...
const page = () => {
  ...
  return (
    <div className="bg-gray-200 rounded-md w-full py-10 px-10 min-h-screen  flex md:flex-row flex-col md:items-start items-center md:justify-center">
     <div className="flex md:flex-row   flex-col  h-max">
     <div className="flex items-center p-10 md:w-[50%] w-full  bg-white">
        <ul className="w-full flex flex-col gap-2">
          <li className="w-full bg-red-500 flex justify-center rounded-md">
            <a
              href=""
          ...
          <li className="w-full bg-blue-700 flex justify-center rounded-md">
            <a
              href=""
              className="py-2 w-full flex justify-center items-center gap-2 text-white font-normal "
            >
          ...
          <li className="w-full bg-blue-500 flex justify-center rounded-md">
            <a
              href=""
              className="py-2 w-full flex justify-center items-center gap-2 text-white font-normal "
            >
          ...
          <li className="w-full bg-black flex justify-center rounded-md">
            <a
              href=""
              className="py-2 w-full flex justify-center items-center gap-2 text-white font-normal "
            >
